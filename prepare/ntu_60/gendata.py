...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/mnt/data/datasets/nturgb+d_skeletons/')
    parser.add_argument('--ignored_sample_path',
                        default='./missing_new.txt')
    parser.add_argument('--out_folder', default='/mnt/data/datasets/ntu_60/')
