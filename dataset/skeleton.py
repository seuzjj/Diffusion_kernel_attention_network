...
trainsiteindex = [list(range(83)),list(range(83,299)),list(range(299,347)),list(range(347,426)),list(range(426,511)), list(range(0,709))]
testsiteindex = [list(range(37-26)),list(range(37-26,78-26)),list(range(78-26,103-26)),list(range(103-26,137-26)), list(range(137-26,188-26)), list(range(188-26,197-26))]
...
class Skeleton(Dataset):
    def __init__(self, data_path, label_path, window_size, final_size,
                 ...
                 random_choose=False, center_choose=False, random_noise=False, random_scale=False, site=0):
    ...
    def load_data(self):
        ...
        if self.site:
            self.sample_name = self.sample_name[trainsiteindex[self.site]]
            self.label = self.label[trainsiteindex[self.site]]
            self.data = self.data[trainsiteindex[self.site]]
...
class Skeleton_val(Dataset):
    def __init__(self, data_path, label_path, window_size, final_size,augtimes=1,
                 mode='train', decouple_spatial=False, num_skip_frame=None,
                 random_choose=False, center_choose=False, random_noise=False, random_scale=False, site=0):
        self.data_path = data_path
        self.label_path = label_path
    ...
    def load_data(self):
        ...
        with open(self.data_path, 'rb') as f:
            self.data = pickle.load(f)
        if self.site:
            self.sample_name = self.sample_name[testsiteindex[self.site]]
            self.label = self.label[testsiteindex[self.site]]
            self.data = self.data[testsiteindex[self.site]]
