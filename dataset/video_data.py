...
def add_random_noise(data_numpy, scale=0.1):
    return data_numpy + scale * torch.randn(data_numpy.shape)

def random_scale(data_numpy, range=0.2):
    scale = random.uniform(1-range,1+range)
    return scale * data_numpy
